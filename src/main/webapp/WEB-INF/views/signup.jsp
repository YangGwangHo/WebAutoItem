...
<%@include file="top.jsp"%>    
    ...
    <div class="container" style="margin-top:100px">
      <form class="form-horizontal" id="joinform" role="form" method="post" action="join.do" >
  ...
  신용정보의 수집/처리 및 이용 등에 관한 기록 : 3년 (신용정보의 이용 및 보호에 관한 법률)
          ...
          <div class="form-group" id="divId">
              ...
              <div class="col-lg-10">
                  <input type="text" style="display:inline-block;width:84%" class="form-control onlyAlphabetAndNumber" id="id" name="id" data-rule-required="true" placeholder="30자이내의 알파벳, 언더스코어(_), 숫자만 입력 가능합니다." maxlength="30">
                  <button type="button" id="userIdCheck" class="btn btn-default" style="width:14%; margin-left:10px">중복체크</button>
              </div>
          </div>
          ...
          <div class="form-group">
              ...
              <div class="col-lg-10">
                  <label class="radio-inline">
                      <input type="radio" id="e_agree" name="e_agree" value="Y" checked> 동의합니다.
                  </label>
                  <label class="radio-inline">
                      <input type="radio" id="e_agree" name="e_agree" value="N"> 동의하지 않습니다.
                  </label>
              </div>
          </div>
          <div class="form-group">
              ...
              <div class="col-lg-10">
                  <label class="radio-inline">
                      <input type="radio" id="s_agree" name="s_agree" value="Y" checked> 동의합니다.
                  </label>
                  <label class="radio-inline">
                      <input type="radio" id="s_agree" name="s_agree" value="N"> 동의하지 않습니다.
                  </label>
              </div>
          </div>
          <div class="form-group">
              <div class="col-lg-offset-2 col-lg-10">
                  <button type="button" id="signupBtn" class="btn btn-default">Sign Up</button>
              </div>
          </div>
      </form>
    </div>
        ...
        else
        {
        	$.ajax({
        		...
        		success : function(result){
        			if(result.result==0){        				
        				var con_firm = confirm("사용이 가능한 아이디입니다. 사용하시겠습니까?");
        				if(con_firm == true){        			
	...
	<script>
	document.getElementById("signupBtn").onclick = function signupBtnCheck(){
		if($('#id').attr("readonly")!="readonly")
			alert("중복체크를 해주세요.");
		else if($('#pwd').val()!=$("#passwordCheck").val())
